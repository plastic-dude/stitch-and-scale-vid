...
Captions must be synchronized, complete, readable, and human-reviewed. Keep text out of the lower caption zone and never cover finding, scope, expected, actual, evidence, context, owner, next action, tables, numbers, hands, logos, buttons, menus, or primary actions. Review at 320×568, 360×800, 390×844, and 430×932-equivalent phone views where possible, plus desktop and caption-free playback. If product proof later arrives, separately test finding scope, expected/actual semantics, evidence attachment, context/environment, owner/next-action semantics, accessible error identification, correction suggestion, and human evidence gates. Do not turn platform or accessibility checks into a claim that the product offers actionability, issue handoff, reproduction, correction, or completion.
...
[4] [W3C — Understanding Error Identification (WCAG 2.2)](https://www.w3.org/WAI/WCAG22/Understanding/error-identification.html)
