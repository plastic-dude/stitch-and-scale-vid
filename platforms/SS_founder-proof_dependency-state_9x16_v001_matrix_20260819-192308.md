...
Captions must be synchronized, complete, readable, and human-reviewed. Keep text out of the lower caption zone and never cover changed input, dependents, last-built-from, stale, rechecked, owner, affected output, release state, tables, numbers, hands, logos, buttons, menus, or primary actions. Review at 320×568, 360×800, 390×844, and 430×932-equivalent phone views where possible, plus desktop and caption-free playback. If product proof later arrives, separately test changed-input dependency links, stale/invalidation semantics, affected-output scope, recheck/owner state, release-state propagation, keyboard/focus, large text, reduced motion, interruption recovery, and chart/schematic/export use. Do not turn platform or accessibility checks into a claim that the product offers lineage, stale-output detection, release safety, or accurate grading/export.
