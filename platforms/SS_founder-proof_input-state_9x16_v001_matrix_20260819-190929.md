...
Captions must be synchronized, complete, readable, and human-reviewed. Keep text out of the lower caption zone and never cover origin, actor, default, copy, inheritance, estimate, review, use, tables, numbers, hands, logos, buttons, menus, or primary actions. Review at 320×568, 360×800, 390×844, and 430×932-equivalent phone views where possible, plus desktop and caption-free playback. If product proof later arrives, separately test origin labels, user/system change state, confirmation, input purpose, mobile keyboard/focus, large text, reduced motion, interruption recovery, and error identification. Do not turn platform or accessibility checks into a claim that the product offers autofill safety, provenance, accurate calculations, or origin-aware grading/export.
