...
Captions must be synchronized, complete, readable, and human-reviewed. Keep text out of the lower caption zone and never cover preview version, render target, page size, scale, page breaks, margins, reading order, final check, tables, numbers, hands, logos, buttons, menus, or primary actions. Review at 320×568, 360×800, 390×844, and 430×932-equivalent phone views where possible, plus desktop and caption-free playback. If product proof later arrives, separately test preview version identity, render target, page size, scale, page-break behavior, margins, reading order, chart geometry, schematic scale, PDF tags, document language, physical print fidelity, and final target-medium review. Do not turn platform or accessibility checks into a claim that the product offers preview-to-export fidelity, print fidelity, chart geometry, or PDF accessibility.
