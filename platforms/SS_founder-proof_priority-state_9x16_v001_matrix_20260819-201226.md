...
Captions must be synchronized, complete, readable, and human-reviewed. Keep text out of the lower caption zone and never cover impact, urgency, due, owner, priority, reason, escalation, reviewed, tables, numbers, hands, logos, buttons, menus, or primary actions. Review at 320×568, 360×800, 390×844, and 430×932-equivalent phone views where possible, plus desktop and caption-free playback. If product proof later arrives, separately test impact/urgency field semantics, due/owner display, priority reason, queue ordering, escalation behavior, accessible status announcement, and notification urgency/permission boundaries. Do not turn platform or accessibility checks into a claim that the product offers triage, priority, escalation, or completion.
