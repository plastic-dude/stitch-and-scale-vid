...
Captions must be synchronized, complete, readable, and human-reviewed. Keep text out of the lower caption zone and never cover left, right, compared-at, difference, decision, owner, follow-up, status, tables, numbers, hands, logos, buttons, menus, or primary actions. Review at 320×568, 360×800, 390×844, and 430×932-equivalent phone views where possible, plus desktop and caption-free playback. If product proof later arrives, separately test side-by-side comparison, discrepancy detection, compare-at time semantics, resolution decision, owner/follow-up semantics, status propagation, provenance links, and human evidence gates. Do not turn platform or accessibility checks into a claim that the product offers reconciliation, agreement, discrepancy resolution, audit, or completion.
