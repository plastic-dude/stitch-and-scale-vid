...
Captions must be synchronized, complete, readable, and human-reviewed. Keep text out of the lower caption zone and never cover last opened, draft state, selected context, pending action, resume point, restored, unsaved input, verify before continue, tables, numbers, hands, logos, buttons, menus, or primary actions. Review at 320×568, 360×800, 390×844, and 430×932-equivalent phone views where possible, plus desktop and caption-free playback. If product proof later arrives, separately test interruption/restart, draft restoration, selected-context restoration, pending-action state, resume point, unsaved-input handling, restore notice, verification-before-continue, keyboard/focus, large text, reduced motion, and caption-free playback. Do not turn platform or accessibility checks into a claim that the product offers persistence, restore accuracy, or correct continuation.
