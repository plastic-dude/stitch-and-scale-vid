...
Captions must be synchronized, complete, readable, and human-reviewed. Keep text out of the lower caption zone and never cover target, observed, difference, ease, tolerance, uncertainty, rounding, decision, explanation, tables, numbers, hands, logos, buttons, menus, or primary actions. Review at 320×568, 360×800, 390×844, and 430×932-equivalent phone views where possible, plus desktop and caption-free playback. If product proof later arrives, separately test target/observed labels, ease/tolerance band semantics, uncertainty and rounding explanation, decision reason, error text, keyboard/focus, large text, reduced motion, interruption recovery, and chart/schematic/export use. Do not turn platform or accessibility checks into a claim that the product offers fit correctness, measurement quality, accurate calculations, or pass/fail capability.
