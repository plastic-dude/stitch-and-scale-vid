...
Captions must be synchronized, complete, readable, and human-reviewed. Keep text out of the lower caption zone and never cover value, unit, scale, reference, conversion, display, entered-as, used-as, tables, numbers, hands, logos, buttons, menus, or primary actions. Review at 320×568, 360×800, 390×844, and 430×932-equivalent phone views where possible, plus desktop and caption-free playback. If product proof later arrives, separately test unit input, visible label/instructions, unit/reference persistence through grading, chart/schematic display, export, keyboard/focus, large text, reduced motion, and error identification. Do not turn platform or accessibility checks into a claim that the product offers conversion correctness, localization correctness, or calculation accuracy.
