# Wide Director Research — 2026-08-19

## Fresh question

Where does a pattern move from “the math works” to “a reader can successfully use and publish from this,” and what evidence surface could tell that story without duplicating the blocked `false-completion` or `release-gate-roster` concepts?

## Primary findings

Knitty’s current submission guide, last updated June 17, 2026, distinguishes a pattern that works from a designer’s ability to prepare a publication-ready submission. It asks contributors to use its current style-guide template, states that patterns must be solid, mathematically coherent, and followable by readers, and describes technical editors as experienced guides who help newer designers solve mathematical mistakes and improve fit without doing the work for them. Knitty also emphasizes diversity in body size, age, gender identity, physical ability, cultural heritage, and skin color in the designs and photos it publishes. Source: https://knitty.com/subguide.php

The Craft Yarn Council states that publishers, designers, and manufacturers developed standards and symbols to bring uniformity to yarn and needle labeling and to patterns across books, magazines, leaflets, and yarn labels. Its standards cover yarn weight, knit chart symbols, abbreviations, project levels, standard body measurements and sizing, and tool sizes. The stated purpose is consumer-friendliness and helping people select materials and complete a project successfully. Source: https://www.craftyarncouncil.com/standards

## Creative implication

The fresh opportunity is not another “a checkbox can lie” or “show who tested the size” story. The evidence suggests a distinct **reader handoff** angle: publication quality is also the moment a pattern leaves its author and becomes a usable instruction for an unknown reader. A possible dramatic engine is an instruction changing hands from designer desk to reader decision: the designer must make terminology, symbols, sizing, and directions legible to someone who was not in the room. This must remain provisional until current Stitch & Scale product proof can show a real reader-facing or publication-preflight surface. No product claim is authorized from these sources alone.

## Constraints and uncertainty

The sources support publication clarity, standards, mathematical coherence, technical-editor guidance, and reader usability as legitimate workflow concerns. They do not prove that Stitch & Scale currently provides style-guide checking, standards compliance, reader simulation, or publication approval. The concept must therefore remain `blocked` or `director-review` until a current, approved, non-private product capture or proof-registry entry shows the exact surface used in the film. Technical editing, physical print review, chart readability, schematic scale, and test knitting remain distinct human gates.

## Research decision changed

The next concept should explore **reader handoff and language/symbol translation**, not false completion, tester ownership, or broad publication labor. It should not state that the product automatically validates standards or guarantees reader success. A human reader, editor, or test knitter remains evidence; the product can only be shown doing what a current capture proves.

## Accessibility and platform findings

W3C’s Web Accessibility Initiative defines captions as synchronized text containing speech and the non-speech audio information needed to understand the content. It explicitly warns that automatically generated captions are not sufficient unless confirmed fully accurate and usually require significant editing; it also identifies WebVTT as a common web caption format and shows speaker identification for multi-speaker media. Source: https://www.w3.org/WAI/media/av/captions/

YouTube’s current Help guidance says subtitles and captions expand access to deaf or hard-of-hearing viewers and viewers who speak another language. It supports uploading a caption file, auto-sync, manual typing, and auto-translation, while noting that automatic captions are created only in the video’s default language. Source: https://support.google.com/youtube/answer/2734796?hl=en

## Production implication

The campaign’s acceptance gate should require a human-reviewed caption file and a caption-on/caption-free review, not merely an automatic transcript. If multiple speakers or quoted voices appear, the caption plan must identify speakers. The story opportunity remains reader handoff, but the film itself must model a trustworthy handoff: precise words, synchronized captions, and no UI/proof obstruction.

## Current product check

The local export route `http://127.0.0.1:5000/project/sample-crew-neck-sweater/pdf` returned HTTP 200 from the local preview endpoint on 2026-08-19. The connected browser could not establish a receiving connection for visual inspection in this run, so the route’s current labels, controls, and rendered proof were not treated as visually verified product evidence. The campaign must not cite any specific UI behavior until a current capture or registry entry is obtained.

## Sizing and reader-handoff findings

The Craft Yarn Council’s body-sizing guidance says finished-garment fit depends on taking body measurements and reviewing all sizing information before beginning. It distinguishes actual body measurements from finished garment measurements, notes that patterns often include schematics across sizes, and explains ease categories from negative ease through oversized positive ease. It also states that fit and length charts are guidelines and that individual changes may be appropriate. Source: https://www.craftyarncouncil.com/standards/body-sizing

## Creative implication

A reader-handoff story can focus on the decision a reader makes from a pattern’s sizing and ease information, rather than a designer’s checkbox or roster. The film can dramatize “choosing a size from measurements and ease” only if the current product can show an actual, readable, current surface for that decision. The standards support the importance of the distinction; they do not prove that Stitch & Scale currently performs or guarantees it.

## Chart and symbol handoff findings

The Craft Yarn Council’s knit-chart guidance says stitch charts are increasingly used alongside or instead of words, provides commonly used symbols, and warns that there are many project-specific variations. It instructs readers to refer to the pattern key for variations, while noting that symbols generally represent stitches as viewed from the right side. Source: https://www.craftyarncouncil.com/standards/knit-chart-symbols

## Creative implication

The reader-handoff angle can be made more specific: a pattern does not merely contain symbols; it hands a reader a key, a convention, and a choice about whether the visual shorthand is interpretable. A possible final image is a reader pausing at a chart key rather than a checkbox turning green. This is materially distinct from the imported human-gate concepts, but it still requires current product proof before claiming that Stitch & Scale exposes or checks chart readability.

## References

[1] [Knitty — Design or Write for Knitty](https://knitty.com/subguide.php)

[2] [Craft Yarn Council — Standards and Guidelines](https://www.craftyarncouncil.com/standards)

[3] [Craft Yarn Council — Standard Body Measurements/Sizing](https://www.craftyarncouncil.com/standards/body-sizing)

[4] [Craft Yarn Council — Knit Chart Symbols](https://www.craftyarncouncil.com/standards/knit-chart-symbols)
...
## Forty-third wide-research question: which copy is this? — 2026-08-19

### Research question
How can an independent designer distinguish a draft, review copy, tester copy, and released pattern so nobody works from the wrong artifact—without claiming Stitch & Scale has version history, release labels, change notes, or automatic distribution?

### Campaign classification assumption
No active human brief was supplied in the refreshed repository state. This run assumes year-round founding-tester recruitment through the free demo and early-access cohort. The audience is independent knitwear designers preparing patterns, test copies, print previews, and release artifacts. The form is a 45-second vertical proof-led short for organic Instagram Reels, TikTok, and YouTube Shorts. The tone is first-person, quiet, specific, dry, and craft-respectful. The brief tier is a standard single-original-video planning package. No seasonal deadline or artificial urgency is assumed.

### Evidence gathered

| Source | Date checked | Evidence | Uncertainty / boundary | Decision changed |
|---|---:|---|---|---|
| GOV.UK Content and Publishing Guidance, “Manuals” | 2026-08-19; current page checked | Manuals guidance distinguishes creating a draft from publishing the draft, supports change notes for recording updates, and frames manuals as content users think of as a single body or document. | Government publishing workflow, not proof of Stitch & Scale draft/review/release labels or distribution behavior. | A tester-facing artifact concept should name its state and change note rather than relying on a filename or visual similarity. |
| ONS Service Manual, “PDF and Word documents” | 2026-08-19; current page checked | ONS says PDF-only or Word-only content can be difficult for assistive technology and essential information should be available as HTML. It recommends clear, descriptive file names that describe the topic or purpose and avoid autogenerated meaningless sequences. | ONS publishing guidance, not a knitwear release standard and not proof of Stitch & Scale export or HTML behavior. | If an artifact is shown, make its state and purpose readable in the frame and preserve an accessible text alternative; do not imply a file name alone proves currentness. |
| Yarnpond workflow description and prior test-knit research | 2026-08-19; current workflow page and prior research record | Test calls and pattern workflows may expose updated pattern versions, milestones, and tester-facing terms; prior research also distinguishes test copies from released artifacts. | Community/platform workflow evidence, not universal practice and not Stitch & Scale proof. | Distinguish `DRAFT / REVIEW / TEST COPY / RELEASE` and show a change note or scope before a tester uses an artifact. |
| Craft-business records and publishing contracts | 2026-08-19; internal contracts | Records and exports need stable identifiers, source notes, status, history, print/mobile readability, localization, and human review. | Internal design contracts, not current UI proof. | Select `artifact-status`: make the identity and state of the artifact explicit before it is handed off. |

### Product-state reconciliation

The refreshed repository has no product-proof registry entry or approved capture for artifact headers, draft/review/test/release badges, version/date markers, change-note panels, release-state labels, or accessible artifact metadata surfaces. All 43 wide-research concepts remain blocked or director-review; no open `reviews/`, `orders/`, or `comms/inbox/` files were present. Imported `false-completion` and `release-gate-roster` remain blocked with occupied filenames and are not reopened or reused.

### Decision changed by research

Research changed the angle from generic publication readiness into **artifact identity at the handoff**. The fresh concept is `artifact-status`: a fictional artifact card shows `STATE / VERSION / AUDIENCE / CHANGE NOTE` before a tester or reader uses it. The visual device is an original card marked `ILLUSTRATIVE — NOT PRODUCT UI`; no product version history, release label, or distribution behavior is claimed.

### Candidate distinctness

The nearest prior angle is `change-notice`, which focuses on disclosing that a test or requirement changed. `artifact-status` changes the pain to **not knowing which copy/state a person is holding before they begin**. The hook changes to “The file is not ready until its state is readable.” The visual metaphor changes from a changed-version card to an artifact header `DRAFT / REVIEW / TEST COPY / RELEASE` with audience and change-note fields. The proof surface changes from a change notice to a current artifact header, state badge, version/date marker, change-note panel, release-state label, or accessible artifact metadata surface. The emotional turn changes from understanding a change to knowing what one is holding. The final line changes to “Name the copy before you hand it over.”

### Hard boundaries

Do not claim Stitch & Scale has version history, release labels, change notes, automatic distribution, currentness detection, or artifact management without current proof. Do not imply a filename alone proves the latest or correct copy. Do not use real pattern PDFs, tester names, file URLs, or private handoff messages without scoped rights. Preserve technical editing, physical print review, chart readability, schematic scale, and test knitting as distinct human evidence gates.

### References

[115] [GOV.UK Content and Publishing Guidance — Manuals](https://guidance.publishing.service.gov.uk/publish-update-retire-content/other-content-types/manuals/)

[116] [ONS Service Manual — PDF and Word documents](https://service-manual.ons.gov.uk/content/content-types/pdf-and-word-documents)

[117] [Yarnpond — System description](https://www.yarnpond.com/system_description)

[118] [Stitch & Scale — Craft business records contract](file:///home/ubuntu/skills/craft-business-records/SKILL.md)
...
## Seventy-ninth wide-research question: blank is not zero — 2026-08-19

### Research question
For an independent knitwear designer entering measurement, grading, or business records, how can a workflow distinguish blank, zero, not applicable, invalid, estimated, and unverified values without silently turning absence into a factual number?

### Campaign classification assumption
No active human brief was supplied in the refreshed repository state. This run assumes year-round founding-tester recruitment through the free demo and early-access cohort. The audience is independent knitwear designers entering measurement, grading, quantity, or business-record context on phone, tablet, or desktop. The form is a 45-second vertical proof-led founder short for organic Instagram Reels, TikTok, and YouTube Shorts. The tone is first-person, quiet, specific, dry, and craft-respectful. The brief tier is a standard single-original-video planning package. No product accuracy, data-model, validation, accessibility-conformance, revenue, adoption, or customer-outcome claim is assumed.

### Evidence gathered

| Source | Date checked | Evidence | Uncertainty / boundary | Decision changed |
|---|---:|---|---|---|
| W3C WAI, WCAG 2.2 Understanding SC 3.3.1 Error Identification | 2026-08-19; current page checked | When an input error is automatically detected, the field in error must be identified and the error described in text. W3C includes required information omitted and values outside allowed format or values as input errors; it notes that generic native validation may be too vague and may expose only one error at a time. | Informative accessibility guidance; does not prove Stitch & Scale validation, data semantics, or conformance. | Separate blank/omitted from invalid and identify the affected field; do not convert an empty field into zero or imply measurement. |
| W3C WAI, WCAG 2.2 Understanding SC 3.3.3 Error Suggestion | 2026-08-19; current page checked | Where an input error is detected and known correction suggestions exist, suggestions should be provided; W3C explains that this can reduce effort and clarify how to correct omitted or out-of-range inputs. | Informative guidance; does not prove product behavior or error-copy quality. | A value-state surface should keep `NOT PROVIDED`, `INVALID`, and `OUT OF RANGE` distinct enough for an honest correction path. |
| Ranganathan & Hunsberger, “Handling missing data in research,” Perspectives in Clinical Research | 2026-08-19; 2024 open-access article checked | Missing data can arise from refusal, technical error, inability to measure, or other mechanisms; missingness can be completely at random, at random, or not at random. Inappropriate handling can bias or reduce precision; imputation fills missing values and must carry uncertainty rather than being treated as an observed fact. | Research-data guidance is not a knitting standard, product data model, or legal/financial advice. | Preserve missing/not-provided state and reason instead of silently replacing absence with zero or a plausible value. |
| World Health Organization, Data Quality Review: Module 1 | 2026-08-19; current toolkit checked | WHO identifies missing values, bias, measurement error, and human errors in data entry and computation as data-quality limitations, and emphasizes completeness, accuracy, consistency, fit-for-purpose review, and recording limitations. | Health-facility data guidance is not a knitwear workflow. WHO branding and third-party assets are not cleared for video use. | Use only general data-quality context; show state labels and limitations, not a health analogy or endorsement. |
| Sister Mountain, “How to Grade Knitting Patterns Using a Spreadsheet” | 2026-08-19; current page checked | The grading workflow separates size setup, body measurements, gauge, intended ease, units, formulas, and derived stitch/row counts; it recommends keeping intended ease as a separate row and using a structured layout. | Practitioner workflow, not Stitch & Scale product validation or a universal grading standard. | A state-aware field family can show recorded, derived, planned, not-provided, not-applicable, invalid, and unverified values before calculation. |
| Instagram Help, Reel size & aspect ratios | 2026-08-19; current page checked | Reels accept 1.91:1 through 9:16, minimum 30 FPS, and minimum 720px; recommended cover is 420×654 and cannot currently be edited after upload. | Technical values do not prove product behavior or accessibility. | Plan 9:16 at 1080×1920, leave state cards clear of overlays, and make cover selection an approval gate. |
| TikTok for Business, TikTok Auction In-Feed Ads | 2026-08-19; current page checked; updated June 2026 | Paid in-feed guidance recommends 9:16 at least 540×960, up to 10 minutes, maximum four caption lines, and safe-zone files that vary by format and caption length. | Paid guidance is not organic-posting guidance; no paid placement is assumed. | Keep an organic-first master under one minute, center the state card, and recheck account-specific placement before any derivative. |
...
| Stitch & Scale pattern-QA, publishing/export, craft-business-records, and mobile-maker contracts | 2026-08-19; contracts re-read | Internal contracts distinguish recorded fact, derived view, estimate, planned value, source/date, input validation, technical edit, print review, chart readability, schematic scale, and test knit. | Internal contracts; no current product-proof registry entry for value-state semantics. | Block product-specific value-state, validation, calculation, or accuracy claims pending exact proof. |

### Product-state reconciliation

The refreshed repository has no product-proof registry entry or approved capture verifying value-state labels, null/zero semantics, not-applicable handling, invalid-input behavior, or preservation of recorded-versus-derived status. `reviews/`, `orders/`, and `comms/inbox/` contain no open reviewer/remake files. Imported `false-completion` and `release-gate-roster` remain blocked with occupied filenames and are not reopened or reused. All 79 concepts remain blocked or director-review.

### Decision changed by research

Research changed the candidate from generic “data validation” into **whether absence, zero, non-applicability, invalidity, planning, derivation, and uncertainty are visible before a designer calculates from a value or treats it as a record**. The fresh concept is `value-state`: a fictional card places `FIELD / VALUE / STATE / UNIT / SOURCE / DATE / VALIDATION / NOTES`. The visual device is an original card marked `ILLUSTRATIVE — NOT PRODUCT UI`; no product semantic or accuracy claim is made.

### Candidate distinctness

The nearest prior angle is `quantity-basis`, which distinguishes requirement, planned purchase, actual use, leftover, reserve, unit, source, date, and status for quantities. `value-state` changes the pain to **whether a field’s absence or invalidity is being mistaken for a valid number**. The hook changes to “Blank is not zero.” The visual metaphor changes from quantity cards to a field-state strip showing `RECORDED / DERIVED / PLANNED / NOT PROVIDED / NOT APPLICABLE / INVALID / UNVERIFIED`. The proof surface changes from quantity context to a current value-context surface with field/value/state/unit/source/date/validation/notes and exact interaction semantics. The emotional turn changes from traceable quantity basis to honest uncertainty before calculation. The final line changes to “Name the value before you calculate from it.”

This is distinct from `default-state` (a filled value may be inherited or defaulted rather than actively chosen), `basis-label` and `decision-ledger` (classification of a number’s basis for a business decision), `measurement-provenance` (where a measurement came from), `grade-transparency` (why a size changed across a grade path), `data-minimum` (which fields are required), `focus-path` (pointer/keyboard reachability), `recovery-proof` (restoration evidence), `quantity-basis` (requirement versus plan versus observed quantity), and all imported human-gate concepts. It does not reopen, rename, overwrite, or consume any occupied reservation.

### Hard boundaries

Do not claim Stitch & Scale prevents silent coercion, stores nulls distinctly, validates values, suggests corrections, improves accuracy, or preserves every source field without current product/data evidence. Do not use WHO branding, health records, real measurement records, private customer/tester data, copyrighted spreadsheets, third-party screenshots, or personal disability information. Do not state that blank is always missing; a field may be intentionally not applicable or pending a designer decision. Preserve technical editing, physical print review, chart readability, schematic scale, and test knitting as separate human evidence gates.

### References

[314] [W3C WAI — Understanding SC 3.3.1 Error Identification](https://www.w3.org/WAI/WCAG22/Understanding/error-identification.html)

[315] [W3C WAI — Understanding SC 3.3.3 Error Suggestion](https://www.w3.org/WAI/WCAG22/Understanding/error-suggestion.html)

[316] [Ranganathan & Hunsberger — Handling missing data in research](https://pmc.ncbi.nlm.nih.gov/articles/PMC11101000/)

[317] [WHO — Data Quality Review: Module 1, Framework and metrics](https://iris.who.int/bitstreams/5507bb74-c49a-4e2e-b922-3b29d9164999/download)

[318] [Sister Mountain — How to Grade Knitting Patterns Using a Spreadsheet](https://www.sistermountain.com/blog/grade-knitting-patterns-spreadsheet)

[319] [Instagram Help — Reel size & aspect ratios on Instagram](https://help.instagram.com/1038071743007909)

[320] [TikTok for Business — TikTok Auction In-Feed Ads](https://ads.tiktok.com/help/article/tiktok-auction-in-feed-ads)

[321] [YouTube Help — Understand three-minute YouTube Shorts](https://support.google.com/youtube/answer/15424877?hl=en)
...
## One-hundred-twenty-first wide-research question: changed upstream is not reviewed downstream — 20260819-192308

### Research question

When one upstream measurement, gauge, size-chart value, or rule changes, which downstream grading, chart, schematic, or export outputs become stale, and what proves they were rechecked?

### Sources, dates, evidence, and decision impact

| Source | Date/status checked | Evidence used | Limit | Decision changed |
|---|---|---|---|---|
| NIST SP 800-128 — Guide for Security-Focused Configuration Management | 2026-08-19 | Configuration management manages and monitors configurations, minimizes risk, and supports controlled change in relation to the system and its environment. | Security/configuration context; not a Stitch & Scale product claim. | Frame the concept around change impact and recheck obligation, not generic version history. |
| W3C PROV-DM | 2026-08-19 | Provenance describes entities, activities, agents, derivations, usage, generation, and time; it can support assessments of quality, reliability, and trustworthiness and must account for changing entities. | Domain-agnostic provenance model; no product behavior evidence. | Show an upstream entity change influencing downstream artifacts. |
| W3C PROV-O | 2026-08-19 | `wasDerivedFrom`, `used`, and `wasGeneratedBy` express dependency and derivation relationships; provenance chains connect activities and entities. | Ontology specification; not a current product capability claim. | Use a dependency path with an explicit recheck state rather than claiming lineage UI. |
| Snowflake — Data Lineage Essential Guide | 2026-08-19 | Lineage traces origin, transformations, downstream assets, dependencies, ownership, and use; upstream changes require impact analysis and maintained lineage because stale lineage loses trust. | Enterprise data-governance guidance; not Stitch & Scale evidence. | Make stale downstream impact the visual conflict. |
| Stitch & Scale local QA, craft-business, mobile-maker, and publishing/export contracts | Re-read 2026-08-19 | Grading, gauges, charts, schematics, exports, and review gates stay linked to evidence; changed upstream facts cannot be treated as current downstream results without recheck. | Internal contracts, not current product behavior. | Block until one upstream change is linked to affected outputs and recheck state. |

### Research synthesis and decision shift

Changed upstream is not reviewed downstream. Candidate angle: `dependency-state`. Hook: “Changed upstream is not reviewed downstream.” Fictional proof surface: `CHANGED INPUT / DEPENDENTS / LAST BUILT FROM / STALE? / RECHECKED? / OWNER / AFFECTED OUTPUT / RELEASE STATE`, explicitly illustrative until product proof verifies exact labels. Visual metaphor: one upstream card changes and sends a stale signal through dependent grading/chart/schematic/export nodes until each recheck is named. Emotional turn: hidden ripple becomes bounded impact. Final line: “Name what changed before you trust what depends on it.”

### Product-state reconciliation and distinctness

No current product-proof registry or approved capture verifies dependency graphs, stale markers, affected-output lists, last-built-from links, change-impact warnings, recheck records, owners, or release-state propagation. `reviews/`, `orders/`, and `comms/inbox/` are absent at refresh; no open CRITICAL/HIGH remake order exists. Imported `false-completion` and `release-gate-roster` were inspected; both remain blocked, their filenames remain occupied, and neither is reopened, renamed, overwritten, or approved.
...
It is distinct from `authority-state`, `provenance-chain`, `version-lock`, `drift-state`, `supersession-state`, `reproducibility-state`, `conversion-trace`, and `outcome-proof` because those concepts respectively concern controlling fields, source history, exact artifact binding, currency drift, replacement, rerun consistency, conversion steps, and outcome change. `dependency-state` focuses on downstream impact and recheck obligation after an upstream change. It does not reopen or consume imported `false-completion` or `release-gate-roster` reservations.

### Hard boundaries

Do not claim that Stitch & Scale currently exposes dependency graphs, stale markers, invalidation, affected-output lists, last-built-from links, recheck records, owners, or release propagation. Do not use `CHANGED INPUT`, `DEPENDENTS`, `LAST BUILT FROM`, `STALE?`, `RECHECKED?`, `OWNER`, `AFFECTED OUTPUT`, or `RELEASE STATE` as current product UI. Do not claim lineage, invalidation, release safety, calculation accuracy, adoption, revenue, or outcomes. Preserve technical editing, physical print review, chart readability, schematic scale, and test knitting as distinct human evidence gates. If David is named, describe him only as a developer whose late mother knitted.
...
## One-hundred-forty-eighth wide-research question: sampled is not representative — 20260819-214620

### Research question

When a craft test, review, or sample is used to support a broader claim, what proves it covers the relevant sizes, conditions, and edge cases rather than merely existing?

### Sources, dates, evidence, uncertainty, and decision changed

| Source | Date/status checked | Evidence used | Uncertainty or limit | Decision changed |
|---|---|---|---|---|
| NIST/SEMATECH, *e-Handbook of Statistical Methods* | 2026-08-19 | NIST provides statistical-method guidance for scientists and engineers; the handbook is a methods reference rather than a single claim that a sample is representative. Sampling, variation, and uncertainty require method and context. | Statistical-method reference; not a Stitch & Scale sampling plan, robustness guarantee, or product proof. | Separate “a sample exists” from target population, selection method, sample size, conditions, exclusions, observations, limits, review, and decision. |
| Craft Yarn Council, *Industry Standards and Guidelines for Designers* | 2026-08-19 | CYC describes pattern-quality review across design through editing/printing, company-specific requirements, sample submissions, and review; related pattern-writing guidance emphasizes standards, technical editing, tester feedback, and checking alignment of terms, symbols, charts, materials, and finished result. | Craft guidance; not a product sampling protocol or guarantee that one sample represents every size or condition. | Make the audience pain sample-to-population boundary, not generic test completion or evidence coverage. |
| Stitch & Scale local QA, publishing/export, craft-business, and mobile-maker contracts | Re-read 2026-08-19 | Grading, test knits, calculations, technical edit, charts, schematics, print, records, exports, and human review have separate evidence boundaries; one sample cannot silently replace other gates. | Internal workflow contracts, not current product proof. | Keep `sampling-state` blocked and preserve separate human evidence gates. |

### Research synthesis and concept decision

Sampled is not representative. Candidate angle: `sampling-state`. Hook: “Sampled is not representative.” Fictional proof surface: `TARGET POPULATION / SAMPLE / SELECTION METHOD / SIZE / CONDITIONS / EXCLUSIONS / OBSERVATIONS / LIMITS / REVIEWED / DECISION`, explicitly illustrative until current product proof verifies exact labels. Visual metaphor: one test card sits in a field of many size/condition cards; only an explicit selection method and limits stop the sample from expanding into an unsupported population claim. Emotional turn: “We tested one” becomes “We know what this test can and cannot support.” Final line: “Name what the sample cannot speak for.”

The candidate is distinct from `evidence-coverage` (whether claims map to evidence items), `test-knit-coverage` (whether graded sizes have test-knit evidence), `audit-state` (whether a bounded audit procedure produced findings), `sensitivity-state` (downstream change from input perturbation), and scope concepts. It focuses on sample-to-population boundaries, selection method, sample size, conditions, exclusions, observations, limits, review, and decision—not evidence mapping, size roster completion, audit procedure, perturbation response, or generic scope.

### Product-state reconciliation and blocker

The latest pushed branch is clean at pass 147; the active schedule remains the seven-minute same-chat recurring task with `runAsNewTask=false`, full-auto mode, and timezone `Africa/Lagos`. `reviews/`, `orders/`, and `comms/inbox/` were absent at refresh; no open CRITICAL/HIGH remake order was found. Imported `false-completion` and `release-gate-roster` were inspected through the continuity ledger and canonical imported outputs; both remain blocked, reserved filenames remain occupied, and neither was reopened, renamed, overwritten, or approved.

No current product-proof registry or approved capture verifies target population, sample, selection method, sample size, conditions, exclusions, observations, limits, review, decision semantics, or exact product labels. The package must remain `blocked`. **Next action:** provide one versioned, non-private, rights-cleared approved capture or registry entry showing one craft test or review sample with defined population, selection method, size, conditions, exclusions, observations, limitations, and human review before making any broader claim, then rerun product, claims, rights/privacy, caption, audio, platform, continuity, and acceptance gates.

### Hard boundaries

Do not claim that Stitch & Scale currently exposes target population, sample, selection method, sample size, conditions, exclusions, observations, limits, review, decision semantics, or exact sampling labels. Do not use `TARGET POPULATION`, `SAMPLE`, `SELECTION METHOD`, `SIZE`, `CONDITIONS`, `EXCLUSIONS`, `OBSERVATIONS`, `LIMITS`, `REVIEWED`, or `DECISION` as current product UI. Do not claim that one test supports all sizes or conditions, or that sampling replaces calculation, technical editing, physical print review, chart readability, schematic scale, or test knitting. If David is named, describe him only as a developer whose late mother knitted.
