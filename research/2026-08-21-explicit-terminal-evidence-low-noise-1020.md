# Director Research — Explicit Terminal Evidence and Low-Noise Holds

- **Research ID:** `RESEARCH-20260821-explicit-terminal-evidence-low-noise-1020`
- **Run role:** Temporary Director/Planner
- **Firing:** 177
- **Run time:** 2026-08-21T10:20:00+01:00
- **Status:** Research-backed operational decision

## Fresh research question

How should a recurring Director distinguish an authorized terminal decision from repeated review-hold noise, and which artifact and evidence bindings must remain immutable while the lane is paused?

## Current repository observation

The published Director playbook and `references/publication-control.md` were inspected before this decision. `origin/main` contains another queue-only hold after firing 176. V002 remains `video-ready-for-review`; no independent terminal Reviewer decision, owner action, `REMAKE_REQUIRED` order, or approved-for-generation brief exists. The single-flight lane remains closed.
...
NIST’s AI Risk Management Framework and Playbook emphasize accountability, defined roles, systematic documentation, traceability, and ongoing monitoring. A terminal record should identify the responsible role, exact artifact, explicit decision, and supporting evidence. A repeated hold, silence, or missing decision cannot satisfy that contract. Sources: [NIST AI Risk Management Framework](https://www.nist.gov/itl/ai-risk-management-framework), [NIST AI RMF 1.0](https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-1.pdf), and [NIST AI RMF Playbook](https://airc.nist.gov/airmf-resources/playbook/).

AWS callback-task and human-approval patterns pause execution until a corresponding unique callback returns explicit approval or rejection. This supports a fail-closed V002 lane: queue-only commits, silence, elapsed time, reminders, or generic acknowledgements cannot resume the waiting contract, and a decision for another asset cannot authorize V002. Sources: [AWS Step Functions — Integrating with Resources](https://docs.aws.amazon.com/step-functions/latest/dg/connect-to-resource.html), [AWS Step Functions — Human Approval](https://docs.aws.amazon.com/step-functions/latest/dg/tutorial-human-approval.html), and [AWS — Serverless Manual Approval Steps](https://aws.amazon.com/blogs/compute/implementing-serverless-manual-approval-steps-in-aws-step-functions-and-amazon-api-gateway/).
