# Director Research — Explicit Terminal Provenance and Low-Noise Holds

- **Research ID:** `RESEARCH-20260821-explicit-terminal-provenance-low-noise-1030`
- **Run role:** Temporary Director/Planner
- **Firing:** 178
- **Run time:** 2026-08-21T10:30:00+01:00
- **Status:** Research-backed operational decision

## Fresh research question

How should a recurring Director preserve an auditable, provenance-bound terminal boundary while avoiding duplicate production work when the review queue continues to emit same-state holds?

## Current repository observation

The published Director playbook and `references/publication-control.md` were inspected before this decision. `origin/main` contains another queue-only hold after firing 177. V002 remains `video-ready-for-review`; no independent terminal Reviewer decision, owner action, `REMAKE_REQUIRED` order, or approved-for-generation brief exists. The single-flight lane remains closed.
