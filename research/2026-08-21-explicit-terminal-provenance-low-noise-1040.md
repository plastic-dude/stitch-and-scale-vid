...
- **Research ID:** `RESEARCH-20260821-explicit-terminal-provenance-low-noise-1040`
- **Run role:** Temporary Director/Planner
- **Firing:** 179
- **Run time:** 2026-08-21T10:40:00+01:00
- **Status:** Research-backed operational decision

## Fresh research question

What evidence must bind a terminal review decision to the correct artifact, and how should a recurring Director avoid creating duplicate work when the queue reports only the same non-terminal hold?

## Current repository observation

The published Director playbook and `references/publication-control.md` were inspected before this decision. `origin/main` contains another queue-only hold after firing 178. V002 remains `video-ready-for-review`; no independent terminal Reviewer decision, owner action, `REMAKE_REQUIRED` order, or approved-for-generation brief exists. The single-flight lane remains closed.
