# Director Research — Terminal Evidence, Provenance, and Noise Control

- **Research ID:** `RESEARCH-20260821-terminal-evidence-provenance-noise-1010`
- **Run role:** Temporary Director/Planner
- **Firing:** 176
- **Run time:** 2026-08-21T10:10:00+01:00
- **Status:** Research-backed operational decision

## Fresh research question

What evidence must be present before a recurring review lane can change state, and how should the Director preserve provenance while suppressing repeated non-actionable queue activity?

## Current repository observation

The published Director playbook and `references/publication-control.md` were inspected before this decision. `origin/main` contains another queue-only hold after firing 175. V002 remains `video-ready-for-review`; no independent terminal Reviewer decision, owner action, `REMAKE_REQUIRED` order, or approved-for-generation brief exists. The single-flight lane remains closed.
...
NIST’s AI Risk Management Framework and Playbook emphasize accountable roles, documentation, traceability, and monitoring. A terminal review record should identify the responsible decision-maker, the exact asset, the explicit decision, and supporting evidence. A repeated queue hold or absence of a decision is not sufficient evidence for a quality transition. Sources: [NIST AI Risk Management Framework](https://www.nist.gov/itl/ai-risk-management-framework), [NIST AI RMF 1.0](https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-1.pdf), and [NIST AI RMF Playbook](https://airc.nist.gov/airmf-resources/playbook/).

AWS callback-task and human-approval patterns pause execution until the corresponding unique callback returns explicit approval or rejection. This supports a fail-closed V002 lane: queue-only commits, silence, elapsed time, reminders, or generic acknowledgements cannot resume the waiting contract, and a decision for a different asset cannot authorize V002. Sources: [AWS Step Functions — Integrating with Resources](https://docs.aws.amazon.com/step-functions/latest/dg/connect-to-resource.html), [AWS Step Functions — Human Approval](https://docs.aws.amazon.com/step-functions/latest/dg/tutorial-human-approval.html), and [AWS — Serverless Manual Approval Steps](https://aws.amazon.com/blogs/compute/implementing-serverless-manual-approval-steps-in-aws-step-functions-and-amazon-api-gateway/).

Google SRE guidance emphasizes actionable, high-signal alerts and deduplication of equivalent conditions. The Director should preserve material evidence in append-only records but should not create duplicate briefs or production work from repeated same-state holds. Sources: [Google SRE — Monitoring Distributed Systems](https://sre.google/sre-book/monitoring-distributed-systems/), [Google SRE — Practical Alerting](https://sre.google/sre-book/practical-alerting/), and [Google SRE — Alerting on SLOs](https://sre.google/workbook/alerting-on-slos/).
